// src/components/MealFileUpload.jsx
import React, { useState } from "react";
import { generateClient } from "@aws-amplify/api";
import { createMeal, updateMeal } from "../graphql/mutations";
import { buildNumericFeatures } from "../utils/dateFeatures";
...
async function predictRatio(date, slot, mealKey) {
  ...
  try {
    ...
    if (typeof data?.prediction !== "number") return null;
    return parseFloat(Number(data.prediction).toFixed(4));
  } catch (e) {
